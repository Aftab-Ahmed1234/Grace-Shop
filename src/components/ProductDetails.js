...
export const ProductDescription = () => {
    ...
    return (
        <>
            <div className="div ">
                <div className="row">
                    <div className="col-sm-12 col-lg-3 col-xl-3 col-md-12" style={{width:"20rem" ,height:"20rem"}}>
                        <img width={400} height={400} className={""} src={product.image} alt="" style={{width:"20rem" ,height:"20rem"}}/>
                    </div>
                    <div
